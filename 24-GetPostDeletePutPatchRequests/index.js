        ...
        .then((data) => {
            ...
            container.innerHTML += `
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">${data.address?.phone}</p>
                    <p class="card-text">${data.address?.country}</p>
                    <a href="#" name=${data.id} class="btn btn-info infoBtn">Info</a>
                    <a href="#"  name=${data.id} class="btn btn-danger deleteBtn">Delete</a>
                </div>
            </div>
            `;
