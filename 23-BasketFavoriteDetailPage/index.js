    ...
    cardContainer.innerHTML += `
        ...
        <div class="card-body" style="position: relative">
          ...
          <a href="." class="btn mt-4" style="border:none;"
            ><i
              class="fa-solid fa-basket-shopping basketBtn" name=${item.id}
          ...
          <a href="." class="btn mt-4" style="border:none;"
            ><i
              class="fa-solid fa-heart favBtn" name=${item.id}
  ...
  favBtns.forEach((item) => {
    item.addEventListener("click", function (e) {
      ...
      fetch(url + "/" + itemId).then((res) => res.json()).then((data) => {
        ...
        <img src="${data.image}"  style="width: 60px; height: 60px; overflow: hidden" class="card-img-top" alt="..." />
        <div style="display: inline;"> ${data.title} - ${data.price}</div><button class="btn btn-outline-dark favItem" style="display: inline;"><i class="fa-solid fa-trash"></i></button></div>`;
