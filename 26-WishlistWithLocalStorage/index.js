...
function addBasket() {
  ...
  basketBtns.forEach((btn) => {
    ...
    btn.addEventListener("click", function (e) {
      ...
      if (localArr) {
        arr = localArr;
        // arr = arr.filter(elem => elem != btnId)
        // arr.push(btnId)
...
function addFavourites() {
  ...
  favBtns.forEach((item) => {
    item.addEventListener("click", function () {
      let btnId = this.children[0].getAttribute("name")
      console.log(btnId);
      ...
      if (this.children[0].classList.value == "fa-solid fa-heart") {
        let index = favArr.indexOf(btnId);
        console.log(index)
        console.log(favArr)
        ...
        favArr = favArr.filter(elem => elem != btnId)
        favArr.push(btnId)
        console.log(favArr)
        localStorage.setItem("fav", JSON.stringify(favArr))
